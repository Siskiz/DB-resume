...
public class TestData {
    ...
    public final static String UUID_1 = UUID.randomUUID().toString();
    public final static String UUID_2 = UUID.randomUUID().toString();
    public final static String UUID_3 = UUID.randomUUID().toString();
    public final static String UUID_4 = UUID.randomUUID().toString();
    ...
    static {
        ...
        R1.setContact(ContactType.SKYPE, "skype.org");
